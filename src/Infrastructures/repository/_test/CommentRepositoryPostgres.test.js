...
describe('CommentRepositoryPostgres', () => {
  ...
  describe('verifyCommentExsists function', () => {
    ...
    it('should not throw Not Found Error when comment found', async () => {
      ...
      // Action & Assert
      await expect(commentRepositoryPostgres.verifyCommentExists(commentId)).resolves.not.toThrowError(NotFoundError);
    });
  });
  ...
  describe('verifyCommentOwner function', () => {
    it('should throw AuthorizationError when the owner is invalid', async () => {
      ...
      // Action & Assert
      await expect(commentRepositoryPostgres.verifyCommentOwner(commentId, '')).rejects.toThrowError(AuthorizationError);
    });
